...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Error al iniciar sesión. Por favor, verifique su correo electrónico y contraseña.");
    }
  };
      ...
      <div className="flex justify-center items-center h-full">
        <form onSubmit={handleSubmit} className="max-w-[450px]   w-full  mx-auto  bg-white  p-8  opacity-90">
          ...
          <div className="flex items-center justify-between py-2">
            <label htmlFor="password" className="block text-5sm font-medium leading-6 text-gray-900">
              Password
            </label>
          ...
          <button type="submit" className="w-full py-3 mt-5 bg-red-600  hover:bg-red-500 relative text-white rounded-xl">Ingresar</button>
          <p className="flex items-center text-5sm text-gray-500  mt-5" ><input className="mr-2" type="checkbox" />Recuérdame</p>
