  ...
  return (
    <>
      ...
      <div className="relative min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 bg-gray-500 bg-no-repeat bg-cover relative items-center">
        {/* Fondo girs-blanco opacidad */}
        <div className="absolute bg-white opacity-70 inset-0 z-0"></div>
        {/* Tarjeta blanca */}
        <div className="sm:max-w-md lg:max-w-3xl w-full p-7 bg-white rounded-xl z-10 shadow-lg">
          {/* Texto */}
          ...
          {/* Columnas para que queden alineados derecha e izquierda */}
          <div className="grid grid-flow-col justify-stretch">
            {/* inputs de textos formulario */}
            <div className="flex flex-col w-96 p-4 md:p-2">
            ...
            <div className="flex flex-col-reverse items-center justify-end w-80 py-10 md:p-9">
              <label
